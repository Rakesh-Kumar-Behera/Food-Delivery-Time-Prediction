...
def calculate_time_diff(df):
    ...
    df['Time_Order_picked_formatted'] = df['Order_Date'] + np.where(df['Time_Order_picked'] < df['Time_Ordered'], pd.DateOffset(days=1), pd.DateOffset(days=0)) + df['Time_Order_picked']
...
api_key = "1d311c993f3e40a6ba1b6630df439e20"
...
set_background_image('https://img.freepik.com/free-photo/various-vegetables-black-table-with-space-message_1220-616.jpg?t=st=1738056245~exp=1738059845~hmac=01383ad031677f9729cc67370f7ade2fa62b38b22d63841b0c5345b49b5f9da4&w=1480')
...
if st.button("Get ETA for Delivery!"):
    ...
    input_data['Time_Ordered'] = pd.to_datetime(input_data['Time_Ordered'], format='%H:%M:%S').dt.hour
    ...
    st.success(f'Your Food will arrive in {prediction[0]:.2f} minutes')
